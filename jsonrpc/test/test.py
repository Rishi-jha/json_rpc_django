...
from jsonrpc import jsonrpc_method, _parse_sig
...
class JSONRPCFunctionalTests(JSONServerTestCase):
...
class JSONRPCTest(JSONServerTestCase):
    ...
    def test_authenticated_insufficient_kwargs(self):
        ...
        self.assertTrue('result' not in resp)
